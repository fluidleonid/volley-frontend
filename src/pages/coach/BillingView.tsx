                      ...
                      {record.status === 'Paid' ? (
                        role === 'coach' ? (
                          <button
                            ...
                            className="bg-primary/10 text-primary px-3 py-1 rounded-full text-[13px] font-bold w-[72px] text-center active:scale-95 transition-transform"
                          >
                            Paid
                          </button>
                        ) : (
                          <div className="bg-primary/10 text-primary px-3 py-1 rounded-full text-[13px] font-bold w-[72px] text-center">
                            Paid
                          </div>
                        )
                      ) : (
                        <button
                          onClick={() => setSelectedRecord(record)}
                          className="bg-card text-white hover:bg-brand-surfaceElevated px-3 py-1 rounded-full text-[13px] font-bold w-[72px] text-center active:scale-95 transition-all"
                        >
                          Settle
                        </button>
                      )}
