  ...
  return (
    ...
    >
      <div className="space-y-5 pt-1">
        ...
        <p className="font-sans text-sm text-[#8E8E93] text-center px-4">
        ...
        <div className="relative w-full h-[64px] rounded-[20px] bg-[#1C1C1E] flex items-center justify-between overflow-hidden px-4 border border-[#2C2C2E]/40">
          ...
          <div className="pl-3 pr-2 flex items-center gap-2.5 truncate max-w-[280px]">
            <Send className="h-5 w-5 text-[#68BD44] shrink-0" />
          ...
          <button
            onClick={handleCopy}
            className="pr-3 flex items-center justify-center text-[#8E8E93] hover:text-white transition-colors"
            title="Copy link"
          >
            {copied ? (
              <Check className="h-5 w-5 text-[#68BD44]" />
            ) : (
        ...
        <div className="flex flex-col items-center justify-center p-6 rounded-[24px] bg-[#1C1C1E] border border-[#2C2C2E]/60 space-y-3">
          <div className="p-4 rounded-2xl bg-white flex items-center justify-center shadow-lg">
            <QrCode className="h-32 w-32 text-black" />
          </div>
          <span className="font-sans text-xs text-[#8E8E93]">
        ...
        <div className="mt-[24px]">
          <button
            onClick={handleCopy}
            className="w-full h-[52px] rounded-full bg-[#68BD44] text-[#050505] font-sans text-base font-bold shadow-lg shadow-[#68BD44]/20 transition-all active:scale-95 hover:bg-[#5AA739] flex items-center justify-center gap-2"
          >
            {copied ? (
              <>
