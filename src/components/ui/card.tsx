...
>(({ className, variant = "default", ...props }, ref) => {
  const variantStyles = {
    ...
    elevated: "bg-[#242426] text-white shadow-xl",
    hardmode: "bg-[#2A1E14] border border-[#FF9500]/30 text-white shadow-[0_0_15px_rgba(255,149,0,0.15)]",
    bordered: "bg-transparent border border-[#2C2C2E] text-white",
  }
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-xs text-[#8E8E93]", className)}
    {...props}
  />
))
