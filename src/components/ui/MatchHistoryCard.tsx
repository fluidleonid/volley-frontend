...
export const MatchHistoryCard: React.FC<MatchHistoryCardProps> = ({ match, onClick }) => {
  ...
  return (
    <>
      <div
        onClick={handleClick}
        className="flex flex-row items-center justify-between py-2 w-full h-[64px] min-h-[64px] max-h-[64px] cursor-pointer transition-opacity hover:opacity-90 active:scale-[0.99]"
      >
