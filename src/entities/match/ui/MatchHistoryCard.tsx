    ...
    <>
      ...
      >
        ...
        <div className="w-[100px] shrink-0 flex flex-col items-end justify-center text-right gap-1">
          ...
          <div
            className="relative overflow-visible inline-flex items-center h-[18px] px-[4px] gap-[2px] rounded-full border-0 bg-brand-surfaceElevated"
          >
            <span
              className="font-display text-xs font-bold tracking-tight text-muted-foreground"
            >
            ...
            <div className="relative w-[16px] h-[18px] flex items-center justify-center -translate-y-[4px] shrink-0 pointer-events-none">
              <div
                className="w-[18px] h-[18px] shrink-0 bg-muted-foreground"
                style={{
