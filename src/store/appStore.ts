...
export const useAppStore = create<AppState>((set) => ({
  ...
  leaderboard: [
    ...
    { rank: 9, player: { id: 'lb-9', name: 'Chris P.', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80', level: 11, xp: 2500, status: 'spectating', gamesPlayed: 40, wins: 22, bpToday: 1.2, winStreak: 2 }, wins: 22, winRate: 55.0, xp: 2500 },
    { rank: 10, player: { id: 'lb-10', name: 'Jessica W.', avatarUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&auto=format&fit=crop&q=80', level: 11, xp: 2450, status: 'spectating', gamesPlayed: 39, wins: 21, bpToday: 1.0, winStreak: 1 }, wins: 21, winRate: 53.8, xp: 2450 },
    { rank: 11, player: { id: 'lb-11', name: 'Mark T.', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&auto=format&fit=crop&q=80', level: 10, xp: 2400, status: 'spectating', gamesPlayed: 38, wins: 20, bpToday: 0.8, winStreak: 1 }, wins: 20, winRate: 52.6, xp: 2400 },
    { rank: 12, player: { id: 'lb-12', name: 'Laura C.', avatarUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&auto=format&fit=crop&q=80', level: 10, xp: 2350, status: 'spectating', gamesPlayed: 37, wins: 19, bpToday: 0.7, winStreak: 1 }, wins: 19, winRate: 51.4, xp: 2350 },
    { rank: 13, player: { id: 'lb-13', name: 'Kevin H.', avatarUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&auto=format&fit=crop&q=80', level: 9, xp: 2300, status: 'spectating', gamesPlayed: 36, wins: 18, bpToday: 0.6, winStreak: 1 }, wins: 18, winRate: 50.0, xp: 2300 },
    { rank: 14, player: { id: 'lb-14', name: 'Rachel G.', avatarUrl: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=100&auto=format&fit=crop&q=80', level: 9, xp: 2250, status: 'spectating', gamesPlayed: 35, wins: 17, bpToday: 0.5, winStreak: 1 }, wins: 17, winRate: 48.6, xp: 2250 },
    { rank: 15, player: { id: 'lb-15', name: 'Steven K.', avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&auto=format&fit=crop&q=80', level: 8, xp: 2200, status: 'spectating', gamesPlayed: 34, wins: 16, bpToday: 0.4, winStreak: 1 }, wins: 16, winRate: 47.1, xp: 2200 },
    { rank: 16, player: { id: 'lb-16', name: 'Amanda B.', avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=80', level: 8, xp: 2150, status: 'spectating', gamesPlayed: 33, wins: 15, bpToday: 0.3, winStreak: 1 }, wins: 15, winRate: 45.5, xp: 2150 },
    { rank: 17, player: { id: 'lb-17', name: 'Justin N.', avatarUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&auto=format&fit=crop&q=80', level: 7, xp: 2100, status: 'spectating', gamesPlayed: 32, wins: 14, bpToday: 0.2, winStreak: 1 }, wins: 14, winRate: 43.8, xp: 2100 },
    { rank: 18, player: { id: 'lb-18', name: 'Megan F.', avatarUrl: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&auto=format&fit=crop&q=80', level: 7, xp: 2050, status: 'spectating', gamesPlayed: 31, wins: 13, bpToday: 0.1, winStreak: 1 }, wins: 13, winRate: 41.9, xp: 2050 }
  ],
